      ...
      <div className="about-container">
        <div className="section introduction-section">
          ...
          <p>
            ...
            được thành lập với sứ mệnh mang đến cho độc giả những trải nghiệm
            đọc sách tốt nhất. Chúng tôi cung cấp hơn 100,000 đầu sách từ các
            nhà xuất bản uy tín trong và ngoài nước, với chất lượng đảm bảo và
            giá cả cạnh tranh.
          </p>
          <p>
            Với hệ thống quản lý hiện đại và đội ngũ nhân viên chuyên nghiệp,
            G12Shop cam kết mang đến cho khách hàng dịch vụ mua sắm tiện lợi, an
            toàn và nhanh chóng.
          </p>
        </div>
        ...
        <div className="section mission-vision">
          <div className="card">
            <h3>Sứ mệnh</h3>
            <p>
              Mang đến cho độc giả Việt Nam những cuốn sách chất lượng cao, góp
              phần thúc đẩy văn hóa đọc và kiến thức trong cộng đồng.
            </p>
          </div>
          <div className="card">
            <h3>Tầm nhìn</h3>
            <p>
              Trở thành nền tảng mua sắm sách trực tuyến hàng đầu Việt Nam, được
              khách hàng tin tưởng và yêu mến.
            </p>
          </div>
        </div>
